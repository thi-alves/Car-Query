...
namespace CarQuery.Models
{
    public class Car
    {
        ...
        public Car(string brand, string model, string bodyStyle, int manufacturingYear, int modelYear, short power, string drivetrain, string displacement,
            int valves, string fuelType, string aspiration, int cylinders, string cylinderConfiguration, string enginePosition, string transmissionType, short topspeed, short doors, 
            double price, string shortDescription, string fullDescription, List<Image> images, string videoLink
            )
        {
            Brand = brand;
            Model = model;
        ...
        public Car(CarViewModel carViewModel)
        {
            ...
            Displacement = carViewModel.Displacement;
            Valves = carViewModel.Valves;
            FuelType = carViewModel.FuelType;
            Aspiration = carViewModel.Aspiration;
            Cylinders = carViewModel.Cylinders;
            CylinderConfiguration = carViewModel.CylinderConfiguration;
